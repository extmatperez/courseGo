...
import (
	...
	"github.com/extmatperez/w2GoPrueba/GoTesting/Clase2TM/proyecto/pkg/store"
)
...
type Repository interface {
	...
	Sumar(num1, num2 int, logger Logger) int
}
...
func (repo *repository) Sumar(num1, num2 int, logger Logger) int {
